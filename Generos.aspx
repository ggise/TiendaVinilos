<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="Generos.aspx.cs" Inherits="TiendaVinilos.Generos" %>
            ...
            <asp:Repeater runat="server" ID="repRepetidor">
                <ItemTemplate>
                    <tr>
                        ...
                        <td><%# Eval("Activo") %></td>
                        <td>
                            <asp:Button Text="Desactivar" CssClass="btn btn-danger" ID="btnEliminar" OnClientClick="return confirm('¿Está seguro de que quiere dejar INACTIVO a este genero?');" OnClick="btnEliminar_Click" runat="server" CommandName="GeneroId" CommandArgument='<%# Eval("Id") %>' />
                        </td> 
                        <td>
                            <asp:Button Text="Activar" CssClass="btn btn-success" ID="btnActivar" OnClientClick="return confirm('¿Está seguro de que quiere ACTIVAR a este genero?');" OnClick="btnActivar_Click" runat="server" CommandName="GeneroId" CommandArgument='<%# Eval("Id") %>' />
                        </td>
                         <td>
